...
image: https://picsum.photos/id/537/1248/250
thumbnail: https://picsum.photos/id/537/400/300
date: "2021-02-19"
author: "Toby Gates"
...
snippet:  In this article we are going to explore how to create a component with a 3D starfield type effect similar to the one...
---

## Introduction

In this article we are going to explore how to create a component with a 3D starfield type effect similar to the one on the homepage using [React](https://reactjs.org/) and [Three.js](https://threejs.org/).
