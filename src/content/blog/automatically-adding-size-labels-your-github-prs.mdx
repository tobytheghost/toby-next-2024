...
date: "2023-12-29"
author: Toby Gates
tags: ["GitHub", "JavaScript", "Framer Motion"]
---

## Introduction

Recently i've found it useful to add size labels to PRs. This has allowed my colleages and I to quickly see which PRs were large and which were small, allowing us to prioritise the larger PRs first. It also allowed us to track the size of our PRs over time, which was useful for spotting trends and identifying areas for improvement.
